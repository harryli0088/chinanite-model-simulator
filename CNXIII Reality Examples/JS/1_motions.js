...
models = [
  ...
  },
  {
    ...
    "pre_moves":[
      ...
      {"counts":7, "type":"down"},
      {"counts":8, "dx":-6, "dy":0, "type":"half speed"},
      {"counts":8, "type":"right half speed"},
      {"counts":8, "type":"down half speed"},
      {"counts":8, "type":"left half speed"},
      {"counts":4, "type":"right"}
    ],
    "color":"green"
  },
  ...
  },
  {
    ...
    "pre_moves":[
      ...
      {"counts":1, "dx":2, "dy":1, "type":""},
      {"counts":7, "type":"down"},
      {"counts":4, "dx":-4, "dy":4, "type":""},
      {"counts":4, "type":"pose"},
      {"counts":2, "dx":1, "dy":0, "type":""},
      {"counts":6, "type":"pose"},
      {"counts":8, "dx":-3, "dy":0, "type":"half speed"},
      {"counts":8, "type":"up half speed"},
      {"counts":8, "type":"right half speed"},
      {"counts":8, "type":"down half speed"}
    ],
  ...
  },
  {
    ...
    "pre_moves":[
      ...
      {"counts":1, "dx":-2, "dy":1, "type":""},
      {"counts":7, "type":"down"},
      {"counts":4, "dx":-6, "dy":0, "type":""},
      {"counts":36, "type":"pose"},
      {"counts":28, "type":"kneel"},
      {"counts":4, "type":"pose"},
      {"counts":4, "type":"right"},
      {"counts":8, "type":"up"},
  ...
  },
  {
    ...
    "pre_moves":[
      ...
      {"counts":20, "type":"pose"},
      {"counts":10, "type":"down"},
      {"counts":3, "dx":-5, "dy":0, "type":""},
      {"counts":3, "dx":0, "dy":-4, "type":""},
      {"counts":16, "type":"pose"},
      {"counts":4, "type":"right"},
      {"counts":8, "type":"up"},
      {"counts":1, "dx":1, "dy":1, "type":""},
